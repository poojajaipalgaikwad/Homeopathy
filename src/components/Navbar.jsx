    ...
    <>
      ...
      <nav className='w-full fixed px-5 lg:px-8 xl:px-[8%] py-4 flex justify-between items-center z-50 bg-gray-50 shadow-2xl'>
        ...
        <div className='flex items-center gap-4'>
          ...
          <a href='' className='hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo
            transition-all duration-300 hover:scale-105 hover:bg-green-600 hover:text-white'>
            Book Appointment
          </a>

          {/* Mobile menu button */}
          <button className='block md:hidden ml-3 transition-transform duration-300 hover:scale-110' onClick={()=> setOpen(true)}>
